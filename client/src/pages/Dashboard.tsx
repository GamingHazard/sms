...
export default function Dashboard() {
  ...
  const { role, canEdit, canViewDashboard } = useRole();
    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-display font-bold text-slate-900">
          Welcome Back, {role === "admin" ? "Administrator" : "Teacher"}
        </h2>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          UGX 250,000 from Parent of Aisha K.
                        </p>
            ...
            <CardContent className="flex-1 overflow-y-auto max-h-[600px] space-y-4 pr-2">
              {notices.length === 0 ? (
                ...
                notices.map((notice) => (
                  <div
                    key={notice.id}
                    className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-primary/20 transition-colors"
                  >
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          size="sm"
          variant="outline"
          className="h-8 w-8 p-0 rounded-full border-dashed border-slate-300 hover:border-primary hover:text-primary"
        >
